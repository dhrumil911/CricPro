import { Edit, Trash, MapPin, Calendar, Users, Award } from "lucide-react";
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-between items-start">
          <div className="text-left">
            ...
            <span className="text-[10px] text-slate-505 dark:text-slate-500 font-semibold uppercase mt-0.5 block">{tournament.type} Format</span>
          </div>
        ...
        {/* Metadata Details */}
        <div className="space-y-2 border-t border-slate-200 dark:border-slate-850 pt-3 text-xs text-slate-600 dark:text-slate-400 text-left">
          ...
          <div className="flex items-center gap-2">
            ...
            <span><strong className="text-slate-800 dark:text-slate-300">Teams:</strong> {tournament.teams} Registered</span>
          </div>
          <div className="flex items-center gap-2">
            <Calendar className="w-3.5 h-3.5 text-slate-400 dark:text-slate-500 shrink-0" />
            <span><strong className="text-slate-800 dark:text-slate-300">Duration:</strong> {tournament.duration}</span>
          </div>
        </div>
      </div>
